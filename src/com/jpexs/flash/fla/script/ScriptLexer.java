 ...
 * from the specification file <tt>C:/Dropbox/Programovani/JavaSE/FlaComDoc/lexers/script.flex</tt>
 */
public final class ScriptLexer {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
  public ParsedSymbol yylex() throws java.io.IOException, ScriptParseException {
    int zzInput;
    int zzAction;
