 ...
 * @author JPEXS
 */
public class LoadVariablesCommand extends AbstractCommand {
    ...
    public LoadVariablesCommand(Expression url, int level, String variablesMethod) {
        this.url = url;
        this.level = level;
    ...
    public LoadVariablesCommand(Expression url, Expression levelOrTarget, boolean isTarget, String variablesMethod) {
        this.url = url;
